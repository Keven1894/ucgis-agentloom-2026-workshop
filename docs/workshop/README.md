...
| — | [`start-workshop-servers.md`](./start-workshop-servers.md) | Local `:8766` + `:8000` servers for showcase |
| — | [`showcase.html`](./showcase.html) | Reference demo hub (needs local servers) |
